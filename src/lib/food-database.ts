...
export const PRESET_FOODS: Omit<MealEntry, 'id' | 'date' | 'mealType'>[] = [
  ...
  { name: 'Watermelon (200g)', calories: 60, protein: 1, carbs: 15, fat: 0 },
  { name: 'Pineapple (150g)', calories: 75, protein: 1, carbs: 20, fat: 0 },
  { name: 'Pear (1 medium)', calories: 101, protein: 1, carbs: 27, fat: 0 },
  { name: 'Peach (1 medium)', calories: 59, protein: 1, carbs: 14, fat: 0 },
  { name: 'Kiwi (1 medium)', calories: 42, protein: 1, carbs: 10, fat: 0 },
  { name: 'Cherries (150g)', calories: 95, protein: 2, carbs: 24, fat: 0 },
  // Vegetables
...
export const FOOD_DB: FoodEntry[] = [
  ...
  { keywords: ['grapes', 'grape', 'weintrauben'], name: 'Grapes (150g)', calories: 104, protein: 1, carbs: 27, fat: 0 },
  { keywords: ['watermelon', 'melon', 'wassermelone'], name: 'Watermelon (200g)', calories: 60, protein: 1, carbs: 15, fat: 0 },
  { keywords: ['pineapple', 'ananas'], name: 'Pineapple (150g)', calories: 75, protein: 1, carbs: 20, fat: 0 },
  { keywords: ['pear', 'birne'], name: 'Pear (1 medium)', calories: 101, protein: 1, carbs: 27, fat: 0 },
  { keywords: ['peach', 'pfirsich'], name: 'Peach (1 medium)', calories: 59, protein: 1, carbs: 14, fat: 0 },
  { keywords: ['kiwi'], name: 'Kiwi (1 medium)', calories: 42, protein: 1, carbs: 10, fat: 0 },
  { keywords: ['cherry', 'cherries', 'kirschen'], name: 'Cherries (150g)', calories: 95, protein: 2, carbs: 24, fat: 0 },
  { keywords: ['plum', 'pflaume', 'zwetschke'], name: 'Plum (2 medium)', calories: 60, protein: 1, carbs: 15, fat: 0 },
  { keywords: ['raspberry', 'raspberries', 'himbeeren'], name: 'Raspberries (150g)', calories: 78, protein: 2, carbs: 18, fat: 1 },
  { keywords: ['pomegranate', 'granatapfel'], name: 'Pomegranate (half)', calories: 64, protein: 1, carbs: 16, fat: 1 },
  { keywords: ['grapefruit'], name: 'Grapefruit (half)', calories: 52, protein: 1, carbs: 13, fat: 0 },
  { keywords: ['papaya'], name: 'Papaya (150g)', calories: 59, protein: 1, carbs: 15, fat: 0 },
  { keywords: ['passion fruit', 'maracuja'], name: 'Passion Fruit (2)', calories: 34, protein: 1, carbs: 8, fat: 0 },
  { keywords: ['fig', 'figs', 'feige'], name: 'Figs (2 medium)', calories: 74, protein: 1, carbs: 19, fat: 0 },
  { keywords: ['apricot', 'apricots', 'marille', 'marillen'], name: 'Apricots (3 medium)', calories: 50, protein: 1, carbs: 12, fat: 0 },
  { keywords: ['lemon', 'zitrone'], name: 'Lemon (1)', calories: 17, protein: 1, carbs: 5, fat: 0 },
  { keywords: ['lime', 'limette'], name: 'Lime (1)', calories: 20, protein: 0, carbs: 7, fat: 0 },
  { keywords: ['cantaloupe', 'honeydew', 'honigmelone'], name: 'Cantaloupe/Honeydew (200g)', calories: 68, protein: 2, carbs: 16, fat: 0 },
  { keywords: ['coconut', 'kokosnuss'], name: 'Coconut (50g)', calories: 177, protein: 2, carbs: 8, fat: 17 },
  { keywords: ['fruit', 'mixed fruit', 'fruit salad', 'obstsalat'], name: 'Mixed Fruit (200g)', calories: 100, protein: 1, carbs: 25, fat: 0 },
  // Vegetables
  ...
  { keywords: ['lettuce', 'romaine', 'iceberg', 'kopfsalat'], name: 'Lettuce (100g)', calories: 15, protein: 1, carbs: 3, fat: 0 },
  { keywords: ['celery', 'sellerie'], name: 'Celery (100g)', calories: 16, protein: 1, carbs: 3, fat: 0 },
  { keywords: ['artichoke', 'artischocke'], name: 'Artichoke (1 medium)', calories: 60, protein: 3, carbs: 13, fat: 0 },
  { keywords: ['brussels sprouts', 'sprouts', 'rosenkohl'], name: 'Brussels Sprouts (150g)', calories: 65, protein: 5, carbs: 13, fat: 1 },
  { keywords: ['sweet corn', 'maiskolben'], name: 'Sweet Corn (1 ear)', calories: 90, protein: 3, carbs: 19, fat: 1 },
  { keywords: ['bok choy', 'pak choi'], name: 'Bok Choy (150g)', calories: 20, protein: 2, carbs: 3, fat: 0 },
  { keywords: ['avocado', 'avo'], name: 'Avocado (half)', calories: 160, protein: 2, carbs: 9, fat: 15 },
  { keywords: ['arugula', 'rocket', 'rucola'], name: 'Arugula/Rocket (50g)', calories: 13, protein: 1, carbs: 2, fat: 0 },
  { keywords: ['turnip', 'rübe'], name: 'Turnip (150g)', calories: 42, protein: 1, carbs: 10, fat: 0 },
  { keywords: ['parsnip', 'pastinake'], name: 'Parsnip (150g)', calories: 113, protein: 2, carbs: 27, fat: 0 },
