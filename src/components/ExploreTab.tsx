...
const CATEGORIES: Category[] = [
  {
    ...
    tools: [
      ...
      { id: 'block_suggestion', label: 'AI Program', icon: Sparkles, color: 'from-amber-500/20 to-amber-500/5 text-amber-400' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'profiler', label: 'Exercise Profiler', icon: Target, color: 'from-orange-500/20 to-orange-500/5 text-orange-400' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'injury', label: 'Injury Log', icon: Shield, color: 'from-amber-500/20 to-amber-500/5 text-amber-400' },
      { id: 'illness', label: 'Illness Log', icon: Thermometer, color: 'from-orange-500/20 to-orange-500/5 text-orange-400' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'grip_strength', label: 'Grip Strength', icon: Grip, color: 'from-stone-500/20 to-stone-500/5 text-stone-400' },
