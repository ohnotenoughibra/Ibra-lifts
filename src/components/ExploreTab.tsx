...
const CATEGORIES: Category[] = [
  {
    ...
    tools: [
      ...
      { id: 'sprints', label: 'Air Bike & Sprints', desc: 'Timed intervals, logged', longDesc: 'Air bike, run, row or SkiErg intervals by energy system: alactic power 8×8 s, repeated sprints, 30 s SIT, Norwegian 4×4, fight rounds with surges, Zone 2 flush. Big timer with beeps, logs effort and counts toward training load.', keywords: 'air bike assault bike echo bike airbike sprint sprints intervals hiit sit alactic rsa repeated sprint 4x4 norwegian fight rounds zone 2 conditioning finisher', icon: Zap, color: 'from-amber-500/20 to-amber-500/5 text-amber-400', tab: 'train' },
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            {([
              ...
              { id: 'sprints' as NonNullable<OverlayView>, label: 'Air Bike', desc: 'Sprints & intervals', icon: Zap, color: 'text-amber-400 bg-amber-500/10 border-amber-500/20' },
