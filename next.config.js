  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        },
        {
          ...
          value:
            "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.sentry.io https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://images.unsplash.com; font-src 'self' data:; connect-src 'self' https://*.sentry.io https://va.vercel-scripts.com https://api.whoop.com https://api-7.whoop.com https://world.openfoodfacts.org; frame-src 'self'; worker-src 'self' blob:; manifest-src 'self'; media-src 'self'",
        },
      ],
    },
    {
