...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'wellness_xp', label: 'Wellness XP', desc: 'Gamified wellness tracking', longDesc: 'Track supplements, nutrition, water, sleep, mobility, and mental wellness. Earn XP, build streaks, and unlock a training multiplier', keywords: 'wellness xp gamification supplements nutrition water sleep mobility mental multiplier streak badge level habits', icon: Sparkles, color: 'from-amber-500/20 to-amber-500/5 text-amber-400', isPro: false },
    ],
  },
];
