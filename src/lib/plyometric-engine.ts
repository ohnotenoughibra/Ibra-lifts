...
export const PLYO_LIBRARY: PlyoExercise[] = [
  ...
  { id: 'squat-broad-jump',    name: 'Heavy Squat → Broad Jump',  category: 'contrast',  bodyFocus: 'lower', sets: 4, reps: 3, contactsPerSet: 3, restSeconds: 300, loadGuidance: '85% squat 3 reps, rest 4-6 min, 3 broad jumps', cues: ['Heavy squat first', 'Rest 4-6 min — fatigue masks the potentiation before ~3 min', 'Then 3 max broad jumps', 'Repeat'], videoSearch: 'contrast training squat jump', intensityScore: 9, contrastPairWith: 'back-squat' },
  { id: 'deadlift-vert-jump',  name: 'Heavy DL → Vertical Jump',  category: 'contrast',  bodyFocus: 'lower', sets: 4, reps: 3, contactsPerSet: 3, restSeconds: 300, loadGuidance: '85% DL 1 rep, rest 4-6 min, 3 verticals', cues: ['Single heavy DL pull', 'Rest 4-6 min', 'Max vertical jumps', 'Potentiation peaks ~4-7 min after'], videoSearch: 'contrast training deadlift jump', intensityScore: 9, contrastPairWith: 'deadlift' },
  { id: 'bench-mb-throw',      name: 'Heavy Bench → MB Throw',    category: 'contrast',  bodyFocus: 'upper', sets: 4, reps: 5, contactsPerSet: 5, restSeconds: 300, loadGuidance: '85% bench 3 reps, rest 4-6 min, 5 throws', cues: ['Heavy bench first', 'Rest 4-6 min', '5 max chest passes', 'Potentiation for pushing power'], videoSearch: 'contrast training bench throw', intensityScore: 8, contrastPairWith: 'bench-press' },
];
