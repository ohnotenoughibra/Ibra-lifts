...
export default function CycleTracking({ onClose }: CycleTrackingProps) {
  ...
  return (
    <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} className="min-h-screen bg-grappler-900 bg-mesh pb-20 safe-area-top safe-area-bottom">
      {/* Header */}
